        ...
        <div class="modal-dialog">
            ...
            <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">{{descricaoBotao}} </button>
                </div>
            </form>
            </div>
        </div>
...
return {
    ...
    methods: {
        ...
        async alterarCardapio() {
         await http.put("/cardapio", this.produto)
         this.$emit("aoAlterarCardapio");
       },
    },
    emits: [ "aoAlterarCardapio"],
	computed: {
		descricaoBotao() {
			if (this.$route.path == "/listar") {
